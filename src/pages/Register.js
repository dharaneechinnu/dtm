...
const Register = () => {
    ...
    const handlesubmit = (e) => {
            ...
            if (IsValidate()) {
            //console.log(regobj);
            fetch("https://loginapi-b861.onrender.com/user", {
                method: "POST",
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        <label>Full Name <span className="errmsg" style={{color:"red"}}>*</span></label>
                                ...
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        <label>Country <span className="errmsg" style={{color:"red"}}>*</span></label>
